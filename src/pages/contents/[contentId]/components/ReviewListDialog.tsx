...
export default function ReviewListDialog({
  ...
  }, [open, view, hasNext, loading, fetchMore]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        hideCloseButton
        className="max-w-[1000px] max-h-[646px] bg-gray-800/50 backdrop-blur-[25px] border border-gray-800 rounded-3xl p-9"
      >
        {view === 'list' ? (
          <div className="flex flex-col h-full">
            ...
            <button
              ...
              className="h-[54px] w-full bg-gray-800/50 border-[1.5px] border-gray-800 rounded-xl px-5 py-3.5 flex items-center mt-6"
            >

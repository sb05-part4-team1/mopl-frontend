...
import type {ErrorResponse, ReviewCreateRequest, ReviewUpdateRequest, ReviewDto} from '@/lib/types';
...
export default function ReviewWriteForm({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const errorResponse = (err as { response?: { data: ErrorResponse } })?.response?.data;
      setError(errorResponse?.message || '리뷰 처리에 실패했습니다.');
    } finally {
